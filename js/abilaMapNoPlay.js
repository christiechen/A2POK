function AbilaMapNoPlay(id, gps) {
    var self = this;
...
AbilaMapNoPlay.prototype.init = function () {
    var self = this;
...
AbilaMapNoPlay.prototype.changeTime = function (dates) {
    var self = this;
    ...
    self.svg.selectAll("circle").data(gpsArr).enter().append('circle')
        ...
        .attr('stroke-width', .5)
        .attr('class', (d) => { 
            people.add(`${d.FirstName} ${d.LastName}`); // ====== ADD THE PEOPLE AND ADD THE CLASS 
